define (['jquery'], function ($) {
    ...
    $.get(url + '/stats?artist=Cher&pageid=112915798740840', function (res) {
        QUnit.test("REST API get Cher stats", function( assert ) {
            var obj = JSON.parse(res);
            assert.ok(obj.averageFanAge && obj.firstAlbum && obj.similar && obj.tags, "Passed!" );
        });
    });
    
    $.post(url + '/insertartist', { name: 'TestArtist', url: 'TestURL', pageid:'000000', image:'TestImage'}, function (res) {
    ...
    $.post(url + '/insertalbum', { artist: 'TestArtist', album: 'TestAlbum', url:'TestURL', date:'2013-01-25T00:11:02+0000'}, function (res) {
    ...
    $.post(url + '/inserttag', { artist: 'TestArtist', name: 'TestTag', url:'TestURL'}, function (res) {
    ...
    $.post(url + '/insertfan', { artist: 'TestArtist', url: 'TestURL', age:'0'}, function (res) {
    ...
    $.post(url + '/insertsimilar', { artist: 'TestArtist', similar: 'TestSimilar', url: 'TestURL', image:'TestImage'}, function (res) {
